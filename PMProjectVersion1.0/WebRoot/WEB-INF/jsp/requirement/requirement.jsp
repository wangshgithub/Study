...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-edit"></i>需求信息列表</div>
							</div>
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<button id="addRequirement" class="btn green">
	...
	<![endif]-->
	<script src="<%=basePath %>js/requirement/requirement.js" type="text/javascript"></script>   
	...
	<script src="<%=basePath%>media/js/table-editable.js"></script>    
	<script>
