					...
					<ul class="notifications hidden-sm hidden-xs">
						<li>
							...
							<ul class="dropdown-menu update-menu" role="menu">
								<li><a href="#"><i class="fa fa-database bk-fg-primary"></i>系统管理</a></li>
						...
						<div class="sidebar-menu">						
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-sidebar">
									<li class="nav-parent">
										<a>
											<i class="fa fa-laptop" aria-hidden="true"></i><span>系统管理</span>
										</a>
										<ul class="nav nav-children">
											<li><a href="#"><span class="text">用户管理</span></a></li>
											<li><a href="#"><span class="text">系统设置</span></a></li>
										</ul>
										
									</li>
									<li class="nav-parent">
										<a>
											<i class="fa fa-envelope" aria-hidden="true"></i><span>部门管理</span>
										</a>
									</li>
									<li class="nav-parent">
										<a>
											<i class="fa fa-copy" aria-hidden="true"></i><span>需求管理</span>
										</a>
										<ul class="nav nav-children">
											<li><a href="<%=basePath %>requirementmanage/getRequirementList.do"><span class="text">需求列表</span></a></li>
									...
									<li class="nav-parent">
										<a>
											<i class="fa fa-table" aria-hidden="true"></i><span>信息通讯</span>
										</a>
										<ul class="nav nav-children">
											<li><a href="form-table"><span class="text">table1</span></a></li>
									    </ul>
									</li>
									
									<li class="nav-parent">
										<a>
											<i class="fa fa-random" aria-hidden="true"></i><span>任务调度</span>
										</a>
										<ul class="nav nav-children">
									...
									<li class="nav-parent">
										<a href="widgets.html">
											<i class="fa fa-life-bouy" aria-hidden="true"></i><span>日常管理</span>
										</a>
									</li>
									<li>
										<a href="typography.html">
											<i class="fa fa-font" aria-hidden="true"></i><span></span>
										</a>
									</li>
									<li class="nav-parent">
										<a>
